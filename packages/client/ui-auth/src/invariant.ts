...
/**
 * No runtime invariant: the login overlay is a pathname-gated slot
 * registration whose disposal is proven by the HMR-safety spec, and the form
 * performs plain fetch calls against the host gate — no cordis events, no
