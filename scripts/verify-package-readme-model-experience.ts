...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-auth': { kind: 'none', reason: 'Browser-side login surface; registers nothing model-facing.' },
  ...
  'packages/host/user-auth': { kind: 'none', reason: 'The package hashes passwords and gates the webserver authenticate seat; nothing here reaches a model request.' },
