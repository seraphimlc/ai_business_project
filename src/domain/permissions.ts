...
export const ACTION_ROLE_AUTHORIZATION: Record<Exclude<DomainAction['type'], 'resetDemo'>, readonly RoleName[]> = {
  createProductDraft: ['enterprise_owner', 'product_operator', 'platform_operator'], updateProductDraft: ['enterprise_owner', 'product_operator', 'platform_operator'], uploadProductAsset: ['enterprise_owner', 'product_operator', 'platform_operator'], saveListingContent: ['enterprise_owner', 'product_operator', 'platform_operator'], publishProduct: ['enterprise_owner', 'product_operator', 'platform_operator'], processProductContent: ['enterprise_owner', 'product_operator', 'platform_operator'], startScene: ['enterprise_owner', 'product_operator', 'sales_operator', 'compliance_operator', 'fulfillment_operator', 'platform_operator'], processingComplete: ['product_operator', 'sales_operator', 'compliance_operator', 'fulfillment_operator', 'platform_operator'], confirmCandidate: ['enterprise_owner', 'product_operator', 'sales_operator', 'compliance_operator', 'fulfillment_operator', 'platform_operator'], rejectCandidate: ['enterprise_owner', 'product_operator', 'sales_operator', 'compliance_operator', 'fulfillment_operator', 'platform_operator'], writebackObject: ['enterprise_owner', 'product_operator', 'sales_operator', 'compliance_operator', 'fulfillment_operator', 'platform_operator'], retryWriteback: ['enterprise_owner', 'product_operator', 'sales_operator', 'compliance_operator', 'fulfillment_operator', 'platform_operator'],
