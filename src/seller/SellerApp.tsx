...
export function SellerApp() {
  ...
  return <SellerShell route={route} navigate={navigate} onReset={reset}><>{hydrationNotice && <div className="global-notice" role="status">{hydrationNotice}</div>}{content}</></SellerShell>;
}
